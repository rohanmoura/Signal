    ...
    return (
        <div className='grid p-3 md:p-10 md:grid-cols-2 gap-10 w-full place-content-center'>
                ...
                <div className='md:w-96 mx-auto flex flex-col gap-y-10'>
                    ...
                    <div className='flex flex-col gap-y-5'>
                        <Input className='h-14'
                            type='text'
                            placeholder='Input meeting link' onChange={e => setMeetingCode(e.target.value)} />
                        <Button onClick={startMeeting} disabled={!meetingCode.length}
            ...
            <div className='w-72 h-72 lg:w-96 md:w-[300px] mx-auto lg:h-96 md:h-[300px] rounded-full overflow-hidden'>
                <Image src="https://images.unsplash.com/photo-1654277041050-d8f56bf61b62?q=80&w=1724&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width={500}
                    height={500}
                    alt='meet'
