...
const GroupSheet: FC<GroupSheetProps> = ({
    chatId, groupName
}) => {
    ...
    return (
        <ScrollArea className='h-full'>
            ...
            <div>
                {groupMembers?.members && groupMembers.members.map((member) => (
                    <div key={member._id} className='flex items-center justify-between space-x-3 my-3'>
            ...
            <Dialog open={deleteConfirmationDialog} onOpenChange={() => setDeleteConfirmationDialog(!deleteConfirmationDialog)}>
                <DialogTrigger
                ...
                <DialogContent>
                    ...
                    <div className='flex items-center space-x-3'>
                        <Button variant={"link"} disabled={blockGroupState === 'loading'}
